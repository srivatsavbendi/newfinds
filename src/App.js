...
const MainComponent = () => {
  ...
  const recommended = [
    ...
    },
    {
      ...
      topic: ["Culture", "Science", "Sports", "Politics", "Business"],
      frequency: ["Daily"],
      content: "5 Min.",
  ...
  return (
    <div className="m-0" style={{backgroundColor: backgroundColor, color: backgroundText}}>
      ...
      <div className="mx-5 pt-5 mt-5" >
        <div className="topic-buttons mt-2 mb-1 d-flex justify-content-center">
          <a href="/"><button className="btn me-2 border-0" style={{backgroundColor: "black", color: "white"}}>All</button></a>
          <button className="btn me-2 border-0" style={{backgroundColor: artb, color: artc}} onClick={() => { toggleTopic('Arts'); runart(); }}>Arts</button>
          <button className="btn mx-2 border-0" style={{backgroundColor: topicsColor, color: topicsText}} onClick={() => toggleTopic('Business')}>Business</button>
          <button className="btn mx-2 border-0" style={{backgroundColor: topicsColor, color: topicsText}} onClick={() => toggleTopic('Climate')}>Climate</button>
          <button className="btn mx-2 border-0" style={{backgroundColor: topicsColor, color: topicsText}} onClick={() => toggleTopic('Culture')}>Culture</button>
          <button className="btn mx-2 border-0" style={{backgroundColor: topicsColor, color: topicsText}} onClick={() => toggleTopic('Lifestyle')}>Lifestyle</button>
          <button className="btn mx-2 border-0" style={{backgroundColor: topicsColor, color: topicsText}} onClick={() => toggleTopic('Politics')}>Politics</button>
          <button className="btn mx-2 border-0" style={{backgroundColor: topicsColor, color: topicsText}} onClick={() => toggleTopic('Productivity')}>Productivity</button>
          <button className="btn mx-2 border-0" style={{backgroundColor: topicsColor, color: topicsText}} onClick={() => toggleTopic('Sports')}>Sports</button>
          <button className="btn mx-2 border-0" style={{backgroundColor: topicsColor, color: topicsText}} onClick={() => toggleTopic('Technology')}>Technology</button>
          <button className="btn mx-2 border-0" style={{backgroundColor: topicsColor, color: topicsText}} onClick={() => toggleTopic('Travel')}>Travel</button>
        </div>
      </div>
